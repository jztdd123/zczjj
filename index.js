...
jQuery(async () => {
    ...
    <div class="inline-drawer">
        ...
        <div class="inline-drawer-content">
            ...
            <input type="text" id="summarizer-api-endpoint" class="text_pole" placeholder="https://api.openai.com/v1/chat/completions"></input>
            ...
            <input type="text" id="summarizer-model" class="text_pole" placeholder="gpt-4o-mini"></input>
            <hr></hr>
            <h4>总结设置</h4>
            ...
            <input type="number" id="summarizer-max-msgs" class="text_pole" min="5" max="200" value="20"></input>
            <hr></hr>
            <h4>自动总结</h4>
            ...
            <input type="number" id="summarizer-trigger-interval" class="text_pole" min="10" max="200" value="20"></input>
            <hr></hr>
